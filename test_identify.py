...
if __name__ == '__main__':
    ...
    nii_name = "./sample/verse506.nii.gz"

    # 删除结果文件夹
    if os.path.exists("./results"):
        shutil.rmtree("./results")
    os.mkdir("./results")
    os.mkdir("./results/single_msk")
    os.mkdir("results/npy")
    ...
    save_dir = "./results/npy/" + nii_name[9:-7]
    ...
    write_result_to_file(final_mask, ori_orient_code, ori_spacing, ori_size, ori_aff, "results", nii_name[9:-7] + "_final")
