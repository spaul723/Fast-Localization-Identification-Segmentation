...
class RobustConv(nn.Module):
    # Robust convolution (use high kernel size cla_data-11 for: downsampling and other layers). Train for 300 - 450 epochs.
...
class RobustConv2(nn.Module):
    # Robust convolution 2 (use [32, 5, 2] or [32, cla_data, 4] or [32, 11, 8] for one of the paths in CSP).
